        ...
        <div class="contact__info">
          <div class="contact__info-item flex items-center my-10">
            <div class="contact__info-icon shadow-sm border-2">
              <svg
                xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1A4641"
                class="bi bi-envelope-fill m-5 " viewBox="0 0 16 16">
                <path
            ...
            <div class="flex flex-col mx-2">
              ...
              <a href="mailto:tincaagency@gmail.com" target="_blank" class="contact__info-item-text">
          ...
          <div class="contact__info-item flex items-center my-10">
            <div class="contact__info-icon shadow-sm border-2">
              <svg
                xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1A4641"
                class="bi bi-telephone-fill m-5" viewBox="0 0 16 16">
                <path
                  fill-rule="evenodd"
          ...
          <div class="contact__info-item flex items-center my-10">
            <div class="contact__info-icon shadow-sm border-2">
              <svg
                xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1A4641"
                class="bi bi-geo-alt-fill m-5" viewBox="0 0 16 16">
        ...
        <div class="contact__form">
          <form @submit.prevent="submit">
            <div class="contact__form-item w-full mt-10 mb-5">
              <input
                v-model="user.name" type="text" class="contact__form-item-input rounded-2xl p-4 shadow-sm w-full"
                placeholder="Escribe tu nombre"
                required>
            </div>
            <div class="contact__form-item w-full my-5">
              <input
                v-model="user.email" type="email" class="contact__form-item-input rounded-2xl p-4 shadow-sm w-full"
                placeholder="Escribe tu correo"
                required>
            </div>
            <div class="contact__form-item w-full my-5">
              <textarea
                v-model="user.message" class="contact__form-item-input rounded-2xl p-4 shadow-sm w-full"
            ...
            <p v-if="error !== null " class="text-red-500 font-semibold text-2xl my-3">
              Su mensaje no ha sido envidado. Intente rellenando el formulario o recargando la pagina.
            </p>
            <p v-if="send === true " class="text-green-500 font-semibold text-2xl my-3">
              Su mensaje se envio correctamente. Pronto nos comunicaremos con usted.
            </p>
          </form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async submit() {
      ...
      await this.$axios.post(this.endpoint, data).then((response) => {
